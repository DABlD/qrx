<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ route('dashboard') }}" class="brand-link" style="text-align: center; height: 85px; background-color: white !important;">
        <img src="{{ asset($theme['logo_img'] ?? 'qrtransit/img/qr-transit-logo.png') }}" alt="QR Transit Logo" class="brand-image" style="opacity: .8; max-height: 60px; margin-left: 0px; margin-right: 0px;">
